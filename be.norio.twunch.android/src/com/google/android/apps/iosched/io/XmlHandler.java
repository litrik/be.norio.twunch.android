...
public abstract class XmlHandler {
	 ...
	 */
	public void parseAndApply(XmlPullParser parser, ContentResolver resolver) throws HandlerException {
		try {
	 ...
	 */
	public abstract ArrayList<ContentProviderOperation> parse(XmlPullParser parser, ContentResolver resolver)
			throws XmlPullParserException, IOException;

	/**
	 * General {@link IOException} that indicates a problem occured while parsing
	 * or applying an {@link XmlPullParser}.
	 */
